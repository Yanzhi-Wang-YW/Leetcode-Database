...
def find_inventory_imbalance(stores: pd.DataFrame, inventory: pd.DataFrame) -> pd.DataFrame:
    ...
    most_expensive_product['row_num'] = most_expensive_product.groupby('store_id').cumcount('price') + 1 
    ...
    most_cheapest_product['row_num'] = most_cheapest_product.groupby('store_id').cumcount('price') + 1 
