...
### Note: Replace hardcoded day names with mapping table 
* The mapping table is loaded into Power Query as its own query 
* Table name: `DaysMapping` 
* Column name: `DayName` 
...
* Go to `Pivoted column` tool 
* Look at the **Formula Bar** 
* Delete the `{"Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"}` 
* Replace it with `DaysMapping[DayName]` 
* Go to `Replaced Value` tool 
* Look at the **Formula Bar** 
* Delete the `{"Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"}` 
* Replace it with `DaysMapping[DayName]` 

![alt text](/FabricScreenshot/1479_step7.png) 
![alt text](/FabricScreenshot/1479_step8.png)    
